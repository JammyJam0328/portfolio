...
<template>
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="mx-auto  max-w-5xl my-40 text-white">
      <div class="grid gap-3 sm:flex sm:space-x-3 border-b-2 border-cyan-300">
        <img :src="image" alt="norjamille kasan" class="h-40 sm:h-64 hidden sm:block" />
        <div class="sm:my-auto">
          <div class="flex sm:flex-none items-center space-x-3">
            <img :src="image" alt="norjamille kasan" class="h-24 block sm:hidden" />
            <h1 class="text-2xl  sm:text-4xl mt-5 sm:mt-10 mb-2 uppercase">
              Hi, I'm <span class="text-cyan-300 font-semibold">Norjamille Kasan</span>.
            </h1>
          </div>
          <h1 class="sm:mt-0 mt-5 text-gray-100">
            I'm a full-stack developer. I love building web applications and learning new
            technologies.
          </h1>
          <div class="flex items-center sm:justify-start justify-around space-x-5 mt-5 sm:mb-0 mb-5">
            <a href="#">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" class="h-8">
                <path fill="#e0e0e0"
            ...
            <a href="#">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" class="h-8  rounded-full fill-white">
                <path
